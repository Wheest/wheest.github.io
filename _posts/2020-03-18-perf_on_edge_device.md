...
However, when you're on a non-x86 platform, you cannot always rely that there will be packages for your device, and even if there are, they might be broken in subtle and frustrating ways. This was the case for my colleague.
