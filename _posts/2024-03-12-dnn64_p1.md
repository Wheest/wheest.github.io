...
<center>
<figure class="image">
  <img src="{{site.url}}/assets/n64/rsp.png" alt="Architecture of the Reality Signal Processor (RSP), figure taken from [Rodrigo Copetti](https://www.copetti.org/writings/consoles/nintendo-64/) under [CC BY 4.0 Deed](https://creativecommons.org/licenses/by/4.0/).">
  <figcaption>Architecture of the Reality Signal Processor (RSP), figure taken from [Rodrigo Copetti](https://www.copetti.org/writings/consoles/nintendo-64/) under [CC BY 4.0 Deed](https://creativecommons.org/licenses/by/4.0/).</figcaption>
</figure>
</center>
