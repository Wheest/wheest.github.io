...
Off the back of our [AccML paper on reproducible workflows for AI]({{ site.baseurl }}/blog/2022/06/19/accml_workflows.html), and the AIMDDE project, and [our invited keynote in Madrid]({{ site.baseurl }}/2022/06/30/madrid_keynote.html) on the topic, they thought that we would be good advocates to motivate and demonstrate how SMEs can accelerate their AI application development using AI Assets.
