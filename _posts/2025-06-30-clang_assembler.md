...
assemblers, linkers, and other related tools.
...
compiler _driver_. `clang -cc1` is the compiler, and `clang -cc1as` is the
...
[`clang/tools/driver/cc1as_main.cpp`](https://github.com/llvm/llvm-project/blob/2e7aa7ead6808047df2b7b56bfc725ffc3685e43/clang/tools/driver/cc1as_main.cpp),
