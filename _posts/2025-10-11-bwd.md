...
wrapped up with a Q&A to hear <span class="pronoun"
...
the opportunity to ask _<span class="pronoun" data-type="object"></span>_ some
questions.
...
> I've had a few specific examples, but I don't want to call anyone out.
>
...
<!-- prettier-ignore-start -->
> [<span> class="pronoun" data-type="subject"></span> types on <span>
class="pronoun" data-type="possessive"></span> laptop for a moment, stops, then
starts laughing].
<!-- prettier-ignore-end -->
